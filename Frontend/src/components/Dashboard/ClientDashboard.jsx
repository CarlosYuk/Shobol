...
import { Package, Clock, CheckCircle, AlertCircle, MapPin, Calendar } from 'lucide-react';
...
const ClientDashboard = () => {
  ...
  const upcomingServices = [
    { date: '2024-01-22', service: 'Transporte de Caliza', route: 'Lima - Arequipa' },
    { date: '2024-01-25', service: 'Transporte Industrial', route: 'Cusco - Lima' },
    { date: '2024-01-28', service: 'Transporte Especial', route: 'Iquitos - Lima' }
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-stone-200 p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-stone-900">Envíos Recientes</h3>
            <Package className="h-5 w-5 text-stone-400" />
          </div>
          <div className="space-y-4">
            {recentShipments.map((shipment) => (
              <div key={shipment.id} className="border border-stone-200 rounded-lg p-4">
                ...
                <div className="mb-2">
                  <p className="text-sm font-medium text-stone-700">{shipment.cargo}</p>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-stone-200 p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-stone-900">Próximos Servicios</h3>
            ...
            {upcomingServices.map((service, index) => (
              <div key={index} className="border border-stone-200 rounded-lg p-4">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-sm text-emerald-600 font-medium">{service.date}</span>
                </div>
          ...
          <div className="mt-4">
            <button className="w-full bg-gradient-to-r from-emerald-600 to-lime-600 hover:from-emerald-700 hover:to-lime-700 text-white font-medium py-2 px-4 rounded-lg transition-all">
      ...
      {/* Quick Actions */}
      <div className="bg-white rounded-xl shadow-sm border border-stone-200 p-6">
        <h3 className="text-lg font-semibold text-stone-900 mb-4">Acciones Rápidas</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <button className="flex items-center space-x-3 p-4 border border-stone-200 rounded-lg hover:bg-stone-50 transition-colors">
            ...
            <div className="text-left">
              ...
              <div className="text-sm text-stone-500">Seguimiento en tiempo real</div>
            </div>
          </button>
          <button className="flex items-center space-x-3 p-4 border border-stone-200 rounded-lg hover:bg-stone-50 transition-colors">
